...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		// ส่วนของผลสอบ
			case '8877';
			    $respMessage = 'ชื่อ: ชนากานต์ นามสกุล: โชติประเสริฐ รร.: วัดสวนส้ม(สุขประนุกูล) สำนักเรียน: วัดมหาธาตุยุวราชรังสฤษฎิ์ สอบได้: ธรรมศึกษาชั้นตรี ประกาศนียบัตรเลขที่: กท ๑๔๑๖๒/๐๐๑๐๕ พ.ศ.2562';
			break;
			case '3945';
			    $respMessage = urlencode('ชื่อ: ณธิดา&;nbsp;').'นามสกุล: ลีนะเสน รร.: สุขฤทัย สำนักเรียน: วัดมหาธาตุยุวราชรังสฤษฎิ์ สอบได้: ธรรมศึกษาชั้นตรี ประกาศนียบัตรเลขที่: กท ๑๔๑๖๒/๐๐๒๒๒ พ.ศ.2562';
			break;
			case '';
			    $respMessage = '';
			break;
