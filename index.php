...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		// ส่วนของผลสอบ
			...
			break;
			case '3945';
			    $respMessage = 'ชื่อ: ณธิดา'.'<br>\n'.'นามสกุล: ลีนะเสน รร.: สุขฤทัย สำนักเรียน: วัดมหาธาตุยุวราชรังสฤษฎิ์ สอบได้: ธรรมศึกษาชั้นตรี ประกาศนียบัตรเลขที่: กท ๑๔๑๖๒/๐๐๒๒๒ พ.ศ.2562';
			break;
			case '';
			    $respMessage = '';
			break;
